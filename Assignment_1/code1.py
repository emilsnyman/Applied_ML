...
joblib.dump(num_pipeline, 'pipeline1.pkl')
...
sgd_preds = sgd_reg.predict(exchange_test_prepared)
...
sgd_rmse = np.sqrt(mean_squared_error(exchange_test_labels,sgd_preds))
...
joblib.dump(forest_reg, 'model1.pkl')
